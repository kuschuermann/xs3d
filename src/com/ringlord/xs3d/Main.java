...
/**
 * Entry point of the software, launches the {@link GUI}. Command line arguments
 * are ignored.
 * 
...
final class Main
{
  ...
  {
    System.err.println( "XS3D 1.1 - The Extremely Simple 3D Rendering Engine\n"
	                + "Copyright (C) 2011-2013 K. Udo Schuermann\n" );
  ...
  private static final String LICENSE_TEXT = "This program is free software: you can redistribute it and/or modify\n"
